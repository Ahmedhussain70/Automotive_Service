        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="index.html">Home </a>
 
                    </li>
                    <li class="nav-item"><a class="nav-link" href="about.html">About</a></li>
                    <li class="nav-item dropdown"> <a class="nav-link active" href="services.html" role="button" >Services</a>
                    </li>
                        ...
                        <a href="services-single.html">
                            <div class="wrap">
                                ...
                                <div class="wrapper-title">
                                    <h6 class="fz-20">01.</h6>
                                    <h4 class="fz-20">Tire Change & Repair</h4>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="item mb-30">
                        <a href="services-single.html">
                            <div class="wrap">
                                ...
                                <div class="wrapper-title">
                                    <h6 class="fz-20">02.</h6>
                                    <h4 class="fz-20">Change Oil & Filter</h4>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="item mb-30">
                        <a href="services-single.html">
                            <div class="wrap">
                                ...
                                <div class="wrapper-title">
                                    <h6 class="fz-20">03.</h6>
                                    <h4 class="fz-20">Engine Maintenance</h4>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="item mb-30">
                        <a href="services-single.html">
                            <div class="wrap">
                                ...
                                <div class="wrapper-title">
                                    <h6 class="fz-20">04.</h6>
                                    <h4 class="fz-20">Battery Replacement</h4>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="item mb-30">
                        <a href="services-single.html">
                            <div class="wrap">
                                ...
                                <div class="wrapper-title">
                                    <h6 class="fz-20">05.</h6>
                                    <h4 class="fz-20">Car Wash & Polish</h4>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="item mb-30">
                        <a href="services-single.html">
                            <div class="wrap">
                                ...
                                <div class="wrapper-title">
                                    <h6 class="fz-20">06.</h6>
                                    <h4 class="fz-20">ABS Working & Repair</h4>
                                </div>
                            </div>
                        </a>
                    </div>
