...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Home <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="index2.html" class="dropdown-item"><span>Parallax Image</span></a></li>
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Services <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="services.html" class="dropdown-item"><span>Services 1</span></a></li>
                            <li><a href="services2.html" class="dropdown-item active"><span>Services 2</span></a></li>
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Pages <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" href="#"><span>Other Pages <i class="ti-angle-right"></i></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="services-single.html" class="dropdown-item"><span>Services Single</span></a></li>
    ...
    <!-- Header Banner -->
    <section class="banner-header section-padding bg-img" data-overlay-dark="7" data-background="img/slider/3.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-60 animate-box" data-animate-effect="fadeInUp">
                    <div class="item left">
                        <figure class="img-grayscale"><img src="img/services/1b.jpg" alt="" class="img-fluid rounded-1"></figure>
                        <div class="caption">
                            <h5>Tire Change & Repair</h5>
                            <p>Vivamus tortor risus, pharetra ut venenatis ac, rutrum eget anten fusce convallis nibh felis, eget hendrerit diam rhoncus rana miss dictum lacus eleifend nisl efficitur venenatis.</p> 
                            <a href="services-single.html" class="button-2">Read More <span class="ti-arrow-right"></span></a>
                ...
                <div class="col-md-12 mb-60 animate-box" data-animate-effect="fadeInUp">
                    <div class="item">
                        <figure class="img-grayscale"><img src="img/services/3b.jpg" alt="" class="img-fluid rounded-1"></figure>
                        <div class="caption">
                            <h5>Change Oil & Filter</h5>
                            <p>Vivamus tortor risus, pharetra ut venenatis ac, rutrum eget anten fusce convallis nibh felis, eget hendrerit diam rhoncus rana miss dictum lacus eleifend nisl efficitur venenatis.</p> 
                            <a href="services-single.html" class="button-2">Read More <span class="ti-arrow-right"></span></a>
                ...
                <div class="col-md-12 animate-box" data-animate-effect="fadeInUp">
                    <div class="item left">
                        <figure class="img-grayscale"><img src="img/services/2b.jpg" alt="" class="img-fluid rounded-1"></figure>
                        <div class="caption">
                            <h5>Car Wash & Polish</h5>
                            <p>Vivamus tortor risus, pharetra ut venenatis ac, rutrum eget anten fusce convallis nibh felis, eget hendrerit diam rhoncus rana miss dictum lacus eleifend nisl efficitur venenatis.</p> 
                            <a href="services-single.html" class="button-2">Read More <span class="ti-arrow-right"></span></a>
    ...
    <section class="process section-padding bg-white">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 text-center mt-60"> <a href="#" class="button-2">Book Now <span class="ti-arrow-right"></span></a> </div>
            </div>
        </div>
    </section>
    <!-- Appointment -->
        ...
        <div class="container">
                    ...
                    <div class="col-md-4 widget-area">
                        <div class="widget clearfix">
                            ...
                            <div class="widget-text">
                                <p>Carex imperdiet sapien porttito the bibenum ellentesue the commodo erat nesuen.</p>
            ...
            <div class="bottom-footer-text">
                <div class="row copyright">
                    <div class="col-md-12">
                        <p class="mb-0">&copy;2023 <a href="#">DuruThemes</a>. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
